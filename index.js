...
const { virtex, vipi } = require("./lib/virtex.js"); //mens
...
const bgg = fs.readFileSync('./stik/fake.jpg')
//// Image ////
const time2 = moment().tz("Asia/Jakarta").format("HH:mm:ss");
    if (time2 < "24:59:00") {
      var ucapanWaktu = "Midnight 🌌";
    }
    if (time2 < "19:00:00") {
...
const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `© 𝑳𝒆𝒙𝒙𝒚 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍`,body:"",previewType:"PHOTO",thumbnail:bgg,sourceUrl:`https://wa.me/6283871990243?text=Hello bro`}}})
		}
...
const freply7 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16505434800@s.whatsapp.net' } : {}) }, message: { "productMessage":{"product": {"productImage": {"mimetype":'image/jpg',"jpgThumbnail": iye, "title": `${ucapanWaktu} ${pushname}`, "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
}
 const fkontak = { 
      ...
      message: {
        productMessage: {
          product: {
            productImage: {
              mimetype: "image/jpg",
              jpgThumbnail: fs.readFileSync(`./stik/thumb.jpg`), //The picture
            },
            title: "ALREADY DONE BRO", //Love your name
            description: "SELF BOT",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "Xrutz Ganz",
            productImageCount: 1,
          },
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6283871990243-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FpE1TXXUzuk0TASzYwX8ZM', "groupName": `Xrutz Ganz-Bot Inc.`, "footerText": "*_© Xrutz Ganz_*", "jpgThumbnail": iye, "caption": teks}}, {quoted:mek})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Xrutz Selfbot\nX r u t z. (@rellnjoy_) • Follow Instagram and Like Videos`,
                "body": "",
                "previewType": "PHOTO",
...
case 'menu':
       txtt =`*${ucapanWaktu}*\n*${pushname}*\n*Butuh bantuan?* Silahkan pakai Fitur yang ada di *BotWa!*`
               ...
               imageMsg = (await itsmevall.prepareMessageMedia(fs.readFileSync(`./stik/oksip.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./stik/oksip.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `*Check Fitur dengan Cara :*
Ketik ${prefix}allmenu, Jika button tidak Muncul!
® 𝑳𝒆𝒙𝒙𝒚 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
Mau Chat? *Utamakan kesopanan!*`
               ...
               buttonText:{displayText: 'OWNER'},type:1},
               ...
               contentText: `${ruls}`,
               footerText: `*Check Fitur dengan Cara :*
Ketik ${prefix}allmenu, Jika button tidak Muncul!`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
      ...
      case 'allmenu':
             menu1 = `*[ INFO BOT ]*
き⃟    Prefix : 「 ${prefixStatus ? "Multi Prefix" : "No Prefix"} 」
き⃟    Runtime : ${runtime(process.uptime())}
き⃟    Hit Today : ${hit_today.length} Hit
き⃟    Total Hit : ${totalhit} Hit
き⃟    Total Chat : ${totalchat.length} Chat
...
❏ ${prefix}antihidetag *[button]*
❏ ${prefix}antiviewonce *[button]*
❏ ${prefix}autojoin *[button]*
❏ ${prefix}antivirtex *[button]*
❏ ${prefix}kickarea *[button]*
...
❏ ${prefix}intake
❏ ${prefix}viewonce
❏ ${prefix}vn sec number
❏ ${prefix}video sec number
❏ ${prefix}hbd [ 2005 11 10 ]
...
❏ ${prefix}ss *[ link ]*
❏ ${prefix}lyrics *[ query ]*
❏ ${prefix}namemeaning *[ nama ]*
❏ ${prefix}debug
❏ ${prefix}loli 
❏ ${prefix}debug2
❏ ${prefix}earthquakeinfo
❏ ${prefix}recipes
❏ ${prefix}chat
...
❏ ${prefix}vote
❏ ${prefix}devote`
buttons = [{buttonId:`${prefix}owner`,buttonText:{displayText: 'OWNER BOT'},type:1},{buttonId:`${prefix}ping`,buttonText:{displayText:'SPEED TEST'},type:1},{buttonId:`${prefix}rules`,buttonText:{displayText:'PERATURAN'},type:1}]

               imageMsg = (await itsmevall.prepareMessageMedia(fs.readFileSync(`./stik/oksip.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./stik/oksip.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${menu1}`,
               footerText: `© 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 𝑳𝒆𝒙𝒙𝒚 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
...
break
      /*case "owner":
        sendKontak(from, owner, "Xrutz Ganz", "Busy");*/
             case 'setprofile':
			case 'setpp':
...
case 'owner':
           case 'creator':
               sendKontak(from, `${owner}`, `${fakeyoi}`, 'Sedang Turu!!')
               await sleep(1000)
               ...
               buttonsMessage = { contentText: `${haibg}`, footerText: '© 𝑳𝒆𝒙𝒙𝒚 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍', buttons: buttons, headerType: 1 }
               prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
               itsmevall.relayWAMessage(prep)
               break      
              case 'dice':
...
itsmevall.sendMessage(from,'This is my owners contact',text,{quoted: mek})
break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
break;
      ...
      //------------------< Group Features >-------------------
      case "listonline": //code by Xrutz Ganz
...
case "add":
      ...
      case "setdesc":
        ...
        itsmevall.sendMessage(from, "*Berhasil mengubah Deskripsi Grup!*", text, {
          quoted: mek,
        });
        break;
        // Jadwal Pljrn
...
break
      ...
      case "setname":
        ...
        itsmevall.sendMessage(from, "*Berhasil Mengubah Nama Grup!*", text, {
          quoted: mek,
        });
        break;
      // Group Info
...
case 'santuy':
reply(mess.wait)
sendMediaURL(from,`https://dapuhy-api.herokuapp.com/api/asupan/asupansantuy?apikey=${dapapi}`, `Ni Kak ${pushname}`)
break
case 'leaky':
reply(mess.wait)
sendMediaURL(from,`https://dapuhy-api.herokuapp.com/api/asupan/asupanbocil?apikey=${dapapi}`, `Ni Kak ${pushname}`)
break
case 'ukhti':
reply(mess.wait)
sendMediaURL(from,`https://dapuhy-api.herokuapp.com/api/asupan/asupanukhty?apikey=${dapapi}`, `Ni Kak ${pushname}`)
break
case 'rikagusriani':
reply(mess.wait)
sendMediaURL(from,`https://dapuhy-api.herokuapp.com/api/asupan/asupanrikagusriani?apikey=${dapapi}`, `Ni Kak ${pushname}`)
break
case 'ghea':
reply(mess.wait)
sendMediaURL(from,`https://dapuhy-api.herokuapp.com/api/asupan/asupanghea?apikey=${dapapi}`, `Ni Kak ${pushname}`)
break
...
for (let i = 0; i < args[0]; i++) {
itsmevall.sendMessage(from, `${ucapanWaktu}`, MessageType.extendedText,{
 quoted: {
key: {
...
break
					case 'bug':
  if (!mek.key.fromMe) return;
					if (args.length < 1) return reply('The amount?')
				 for (let i = 0; i < args[0]; i++) {
await itsmevall.toggleDisappearingMessages(from, 0)
}
...
case 'bugpc':
  ...
  if (!mek.key.fromMe) return;
itsmevall.updatePresence(from, Presence.composing)
itsmevall.sendMessage(from, 'okay okay',text, {
 quoted: {
  key: {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/DGXrutz Ganz"
        },
        "index": 0
      }
    ]
...
case "asupan3": // by Xrutz Ganz
  ...
  case 'write': case 'writeabook':            
            if (args.length == 0) return reply(`contoh: ${prefix + command} Xrutz Ganz`)
            reply(mess.wait)
            teks = args.join(" ")
      ...
      case "searchmessage":
        ...
        try {
          ...
          for (let i = 0; i < el.length; i++) {
            await itsmevall.sendMessage(from, "Heres the message", text, {
              quoted: el[i],
            });
          }
         } catch (e) {
...
case 'waifu':
          ...
          case 'wallml':
              ...
              imageMsg = ( await itsmevall.prepareMessage(from, fs.readFileSync(`./${sender}.jpg`), 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
      ...
      case "swm":
        ...
        if ((isMedia && !mek.message.videoMessage) || isQuotedImage) {
          ...
          ffmpeg(media)
            .on("error", (e) => {
              console.log(e);
              itsmevall.sendMessage(from, "There is an error", "conversation", {
                quoted: mek,
              });
              fs.unlinkSync(media);
            })
      ...
      case "self":
        ...
        break;
                case "hidetag":
					...
					itsmevall.sendMessage(from, options, text)
					break;
              case "tagall":
					if (!isGroup) return reply(mess.only.group);
					if (!isGroupAdmins) return reply(mess.admin);
...
itsmevall.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid:[sender]}, quoted : fgif})
break;
      case "eval":
        if (!mek.key.fromMe) return;
        itsmevall.sendMessage(
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
		if (hour_now >= '02:00' && hour_now <= '04:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Subscribe Xrutz Ganz', 'yellow'), color('(🗿)', 'white'))
          }
        ...
        if (hour_now >= '06:00' && hour_now <= '11:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Susbcribe Xrutz Ganz', 'yellow'), color('(🗿)', 'white'))
          }
...
itsmevall.sendMessage(from, Peli, MessageType.sticker, {quoted: mek})
    ...
    e = String(e);// fixed fromMe by Xrutz Ganz
